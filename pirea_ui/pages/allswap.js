      ...
      <Layout>
        <Container>
          <Row>
            ...
            <Col border="primary">
              <Card.Body>
                <Card.Text>makerAddress : </Card.Text>
                <Card.Text>Maker ContractAddress :</Card.Text>
                <Card.Text>tokenId :</Card.Text>
            ...
            <Col>
              <Card.Body>
                <Card.Text>takerAddress : </Card.Text>
                <Card.Text>Taker ContractAddress :</Card.Text>
                <Card.Text>tokenId :</Card.Text>
                <Card.Text>type :</Card.Text>
              </Card.Body>
            </Col>
