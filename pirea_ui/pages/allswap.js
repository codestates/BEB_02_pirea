...
export default function AllSwap() {
  ...
  return (
    <>
      <Layout>
        {data.map((e) => (
          <Container className="allswap-card__container">
            <Row>
              <Col className="card-img">
                ...
                <Button
                  ...
                  size="lg"
                  onClick={() => setMoreMake(true)}
                >
                  More
                </Button>
              </Col>

              <Col className="maker-card">
                <Card.Body>
                  <Card.Text className="text-box">
                    makerAddress : {e.makerAddress}
                  </Card.Text>
                  <Card.Text className="text-box">
                    Maker ContractAddress : {e.wantForm.tokenAddress}
                  </Card.Text>
                  <Card.Text className="text-box">
                    tokenId : {e.wantForm.tokenId}
                  </Card.Text>
                  <Card.Text className="type-box">
                    type : {e.wantForm.type}
                  </Card.Text>
                </Card.Body>
              </Col>

              <Col className="swap-icon" xs="1">
              ...
              <Col className="maker-card">
                <Card.Body>
                  <Card.Text className="text-box">
                    takerAddress : {e.sign.takerAddress}{" "}
                  </Card.Text>
                  <Card.Text className="text-box">
                    Taker ContractAddress : {e.haveForm.tokenAddress}
                  </Card.Text>
                  <Card.Text className="text-box">
